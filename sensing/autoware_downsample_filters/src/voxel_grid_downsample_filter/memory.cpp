  ...
  const std::vector<sensor_msgs::msg::PointField> & fields)
{
  ...
  const auto & field_x = fields.at(static_cast<size_t>(PointIndex::X));
  ...
  const auto & field_y = fields.at(static_cast<size_t>(PointIndex::Y));
  ...
  const auto & field_z = fields.at(static_cast<size_t>(PointIndex::Z));
  ...
  const auto & field_intensity = fields.at(static_cast<size_t>(PointIndex::Intensity));
  ...
  const std::vector<sensor_msgs::msg::PointField> & fields)
{
  ...
  same_layout &= field_intensity.count == 1;
  const auto & field_return_type = fields.at(static_cast<size_t>(PointIndex::ReturnType));
  ...
  const auto & field_ring = fields.at(static_cast<size_t>(PointIndex::Channel));
  ...
  const std::vector<sensor_msgs::msg::PointField> & fields)
{
  ...
  same_layout &= field_return_type.datatype == sensor_msgs::msg::PointField::UINT8;
  same_layout &= field_return_type.count == 1;
  const auto & field_channel = fields.at(static_cast<size_t>(PointIndex::Channel));
  ...
  const auto & field_time_stamp = fields.at(static_cast<size_t>(PointIndex::TimeStamp));
  ...
  const std::vector<sensor_msgs::msg::PointField> & fields)
{
  ...
  same_layout &= field_intensity.datatype == sensor_msgs::msg::PointField::FLOAT32;
  same_layout &= field_intensity.count == 1;
  const auto & field_ring = fields.at(static_cast<size_t>(PointIndex::Ring));
  same_layout &= field_ring.name == "ring";
  same_layout &= field_ring.offset == offsetof(PointXYZIRADRT, ring);
  same_layout &= field_ring.datatype == sensor_msgs::msg::PointField::UINT16;
  same_layout &= field_ring.count == 1;
  const auto & field_azimuth = fields.at(static_cast<size_t>(PointIndex::Azimuth));
  ...
  const auto & field_distance = fields.at(static_cast<size_t>(PointIndex::Distance));
  ...
  const std::vector<sensor_msgs::msg::PointField> & fields)
{
  ...
  same_layout &= field_azimuth.datatype == sensor_msgs::msg::PointField::FLOAT32;
  same_layout &= field_azimuth.count == 1;
  const auto & field_elevation = fields.at(static_cast<size_t>(PointIndex::Elevation));
