...
{
class Lanelet2MapVisualizationNode : public agnocast::Node
{
public:
  explicit Lanelet2MapVisualizationNode(const rclcpp::NodeOptions & options);

private:
  agnocast::Subscription<autoware_map_msgs::msg::LaneletMapBin>::SharedPtr sub_map_bin_;
  agnocast::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr pub_marker_;
