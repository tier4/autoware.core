...
#ifndef AUTOWARE__PLANNING_FACTOR_INTERFACE__PLANNING_FACTOR_BUILDER_HPP_
#define AUTOWARE__PLANNING_FACTOR_INTERFACE__PLANNING_FACTOR_BUILDER_HPP_
...
class PlanningFactorBuilder
{
public:
  explicit PlanningFactorBuilder(std::string name) : name_{std::move(name)} {}
...
extern template void PlanningFactorBuilder::add<autoware_planning_msgs::msg::PathPoint>(
  ...
  const std::string &);
extern template void PlanningFactorBuilder::add<autoware_planning_msgs::msg::TrajectoryPoint>(
...
#endif  // AUTOWARE__PLANNING_FACTOR_INTERFACE__PLANNING_FACTOR_BUILDER_HPP_
