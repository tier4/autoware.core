...
public:
  ...
  const Eigen::VectorXd getSplineCoefficientsCurvature() const { return spline_curvature_.getCoefficients(); }
   ...
   *          recalculated from the extended splines when getSplineInterpolatedCurvatures() is called
   */
